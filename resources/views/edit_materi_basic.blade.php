    ...
    <div class="content">
        <div class="container">
            	<!-- Page-Title -->
						<div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">Edit Materi Basic</h4>
                    <ol class="breadcrumb">
                        <li>
                              ...
                              <form name="upload_modul_form" id="upload_modul_form" enctype="multipart/form-data">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="aspect" name="aspect" class="selectpicker" data-live-search="true"  data-style="btn-white">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="grade" name="grade" class="selectpicker" data-live-search="true"  data-style="btn-white">
